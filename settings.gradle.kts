...
include(":samples:04.0-file-transfer:consumer-customer")
include(":samples:04.0-file-transfer:consumer-manufacturer")
include(":samples:04.0-file-transfer:consumer-vehicle-competitor")
